    ...
    useEffect(() => {
        ...
        for (let row = 0; row < rows; row++) {
            for (let col = 0; col < cols; col++) {
                ...
                square.className = 'bg-primary-100 rounded-lg overflow-hidden transform transition-transform duration-500 ease-out hover:scale-110';
    ...
    return (
        <div className="bg-background-light min-h-screen flex items-center justify-center">
            <main className="container mx-auto px-4 text-center pt-12 md:pt-20">
                ...
                <Link href="/" className="inline-block py-3 px-6 bg-primary-500 text-white font-semibold rounded-full hover:bg-primary-600 transition duration-300 mb-12 focus:outline-none focus:ring-2 focus:ring-primary-300" aria-label="Go back to home page">
                    Take Me Home.
                </Link>

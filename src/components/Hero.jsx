      ...
      <div className="grid grid-cols-12 w-full">
        <div className="place-self-center col-span-12 lg:col-span-7">
          ...
          <Link
            ...
            target="_blank"
            className="text-sm/6 font-semibold text-black-500 hover:text-black-600 inline-flex items-center justify-center px-5 py-3"
          >
            SUBMIT YOUR PROPOSAL <span aria-hidden="true"> →</span>
          </Link>
        </div>
